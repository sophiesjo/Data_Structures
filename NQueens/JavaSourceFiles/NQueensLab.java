 ...
 *
 *    The NQueensLab class implements the N Queens problem. When the problem is solved
 *    the diplay will show in a different color.
 *
 *  @author Alyce Brady and Sophie Sjogren
 *  @version 3 June 2021
 **/
...
public class NQueensLab
{
    ...
    public static void main(String[] args)
    {
        ...
        JMenu helpMenu = new BasicHelpMenu("NQueens",
            "Sophie Sjogren",
            "with assistance from Tabitha",
            "3 June 2021", "file:NQueensHelp.html");
        ...
        NQueens queens = new NQueens(4, display);
        ...
        //Change the blocks of color when the problem is solved
        if(queens.solve())
        {
            display.getDisplay().setBackgroundColor(new Color(0, 255, 155));
            display.getDisplay().showGrid();
        }
        else
        {
            display.getDisplay().setBackgroundColor(new Color(255, 50, 50));
            display.getDisplay().showGrid();
        }
        //queens.solve();
    }
